...
open class PushNotificationBroadcastReceiver : BroadcastReceiver() {
     ...
     */
    object Actions {
        val CLOSE_NOTIFICATION = "com.customlayout.notification.action.CLOSE_NOTIFICATION"
        val OPEN_URL = "com.customlayout.notification.action.OPEN_URL"
        val PRESS_ON_NOTIFICATION = "com.customlayout.notification.action.PRESS_ON_NOTIFICATION"
    }
